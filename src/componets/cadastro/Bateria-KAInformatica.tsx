...
async function deleteBateria(id: string) {
  ...
  return (
    <div className="is-flex"> 
      <div className="content-form-form w-20">
        {/* Formulário de cadastro de bateria */}
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="w-100">
            <label htmlFor="nome">Nome da Bateria:</label>
            <input {...register('nome')} type="text" className="ka-input w-100 center" value={nomeBateria} onChange={handleChangeNomeBateria} id="nome" name="nome" required />
          </div>
          <div className="w-100">
      ...
      <div className="p-10 w-80">   
             <div className="scrollbar">                
                <table border={1} className="ka-table">
                    <thead>
                        <tr><th colSpan={4} className="ka-table-title" >Categorias</th></tr>
                            <tr>
                              <th>flag</th>
                              <th>Nome</th>
                            </tr>
